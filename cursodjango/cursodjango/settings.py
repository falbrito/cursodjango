...
# Usado para tornar o path do projeto sempre "cursodjango"
import os.path
...
STATICFILES_DIRS = (
    ...
    # '/home/projetos/django-para-iniciantes/cursodjango/cursodjango/static',
)
...
SECRET_KEY = '2qur0zit6^rab#()=dh82_5flv28f2n1^y!b%f5@vmyngl6me@'
